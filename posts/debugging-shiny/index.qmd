...
If you'd like to follow along, you can download `tsap` [here](https://github.com/mjfrigaard/tsap/archive/refs/heads/main.zip) or install it using the following: 
...
I'll quickly review the contents of `tsap`. The [`R/` folder](https://github.com/mjfrigaard/tsap/tree/main/R) contains files for the modules: 
