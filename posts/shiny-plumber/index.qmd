...
I've been working through the exercises in Alex K Gold’s [DevOps for Data Science](https://do4ds.com/) and this week I finished the API labs. When the book was written, `plumber2` hadn't been released yet. I went ahead and completed the exercises using both `plumber` and `plumber2`.[^plumbers] 

[^plumbers]: Read a full description of the lab solutions for [`plumber`](https://mjfrigaard.github.io/do4ds-labs/plumber.html) and [`plumber2`](https://mjfrigaard.github.io/do4ds-labs/plumber2.html) in my [DO4DS: Lab Solutions]().
...
%%| echo: false
%%| fig-align: 'center'
%%| fig-cap: 'Parameter Routing: plumber'
%%{init: {'theme': 'base', 'themeVariables': {'fontFamily': 'monospace', 'darkMode': true}}}%%
...
%%| echo: false
%%| fig-align: 'center'
%%| fig-cap: 'Parameter Routing: plumber2'
%%{init: {'theme': 'base', 'themeVariables': {'fontFamily': 'monospace', 'darkMode': true}}}%%
