...
This post was prompted by [this `plumber` GitHub issue](https://github.com/rstudio/plumber/issues/32):
...
The issue has been closed, but I thought the comments/discussion aligned with my own experiences and the resolution was so great it was worth documenting.

BTW--I won't make you scroll to the end of the issue (the resolution is below):

> "*We [the `plumber` developers] took the stance of allowing for many `plumber` apis to be deployed within a single package.*
> 
