...
subtitle: "How assistants made me appreciate writing"
author: "Martin Frigaard"
date: "2026-03-28"
categories: [LLMs, Documentation]
image: "img/image.png"
toc: true
toc-depth: 5
toc-title: 'Contents'
...
With LLM assistants (i.e., those directly in the IDE), I'm writing questions/instructions into a tiny chat text box and reviewing the output. 

![Positron Assistant](img/positron-assistant.png){width='100%'}

There is a record of the conversation, and I can review and approve each step, but the process isolates me from others doing similar work. Instead of exploring documentation or engaging in a conversation with another human about the problem, I’m just asking the machine to solve a problem for me.

![Posit Assistant](img/posit-assistant.png){width='100%'}

## Restricted but intentional use 
